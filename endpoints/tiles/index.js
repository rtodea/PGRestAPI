...
exports.app = function (passport) {
  ...
  var generateMapTileServices = exports.generateMapTileServices = function(app, callback) {
  ...
  generateMapTileServices(app);

  app.put('/admin/update-tile-services', function (req, res) {
    generateMapTileServices(app, function() {
      res.writeHead(200, { 'Content-Type': 'text/plain'});
      res.end('List of map tile services has been updated');
    });
  });
